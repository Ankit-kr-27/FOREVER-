  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input className='border border-gray-300 rounded py-1.5 px-3  w-full ' type="email" placeholder='Email adress'/>
        ...
        <div className='flex gap-3'>
          <input className='border border-gray-300 rounded py-1.5 px-3  w-full ' type="Number" placeholder='pincode'/>
          <input className='border border-gray-300 rounded py-1.5 px-3  w-full ' type="text" placeholder='country'/>
        </div>
        <input className='border border-gray-300 rounded py-1.5 px-3  w-full ' type="Number" placeholder='Phonenumber'/>
      </div>
